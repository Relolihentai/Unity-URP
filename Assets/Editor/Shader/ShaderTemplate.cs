...
{
    public const string shaderTemplatePath = "Assets/Graphics/Shader/Default/Default.shader";
 
    [MenuItem("Assets/Create/Shader/URP Default Shader")]  // 创建的路径
    public static void CreatURPShaderTemplate()
    {
        ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0,
        ScriptableObject.CreateInstance<URPShadertAsset>(),
        GetSelectedPathOrFallback() + "/Default.shader",
        null,
       shaderTemplatePath);
    }
