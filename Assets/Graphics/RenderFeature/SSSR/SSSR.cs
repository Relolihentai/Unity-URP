...
{
    SSSRPass m_ScriptablePass;
    public SSSR_Setting setting;
    public override void Create()
    {
        m_ScriptablePass = new SSSRPass();
    ...
    class SSSRPass : ScriptableRenderPass
    {
        ...
        public void Setup(RTHandle source, SSSR_Setting setting)
        {
