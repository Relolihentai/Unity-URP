...
[Serializable]
public struct GT_TonemapSetting
{
    public Material Material;
    public RenderPassEvent RenderPassEvent;
}
public class GT_Tonemap : ScriptableRendererFeature
{
    GT_TonemapPass m_ScriptablePass;
    public GT_TonemapSetting setting;
    public override void Create()
    {
        m_ScriptablePass = new GT_TonemapPass();
    ...
    class GT_TonemapPass : ScriptableRenderPass
    {
        private Material _material;
        private string _passTag = "GT_TonemapPass";
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            if (_material == null)
            {
                if (Application.isPlaying)
                    Debug.LogError("GT_Tonemap Render Feature '_material' is null");
                return;
            }
            
            if (_sourceRT == null)
            {
                Debug.LogError("GT_Tonemap source RT is null");
                return;
            }
